    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSongs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(AllArtistsActivity.this, AllSongsActivity.class);
                startActivity(i);
            }
        });
        ...
        tvAlbums.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AllArtistsActivity.this, AllAlbumsActivity.class);
                startActivity(i);
            }
        });
        ...
        tvArtists.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AllArtistsActivity.this, AllArtistsActivity.class);
                startActivity(i);
            }
        });
        ...
        tvPlaylists.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AllArtistsActivity.this, AllPlaylistsActivity.class);
                startActivity(i);
            }
        });
    }
